...
When working in a project, Junie aggregates instructions from multiple `.junie/guidelines.md` files:

1. The project-specific guidelines (`./.junie/guidelines.md`).
 
2. The parent directory guidelines (`../.junie/guidelines.md`).

3. The grandparent directory guidelines (`../../.junie/guidelines.md`).
...
To enable Junie to "look upward" for guidelines, you must include the bootstrap instructions at the top of your project's `.junie/guidelines.md` file.

1. Locate the `bootstrap.md` file in this repository.
 
2. Copy its contents.
 
3. Paste it at the very beginning of your project's `.junie/guidelines.md`.
